    ...
    <div className="text text-gray-500 min-h-screen flex flex-col justify-center items-center p-4 mx-auto sm:p-8 gap-5">
        ...
        <div className="h-auto w-full flex justify-center items-center">
            <div className="grid gap-5">
                <div
                    className="w-[95%] border-gray-400 bg-[#101010] rounded-[29px] shadow-lg xl:p-10 2xl:p-10 lg:p-10 md:p-10 sm:p-1">
                    ...
                    <form action="#" method="post" className="space-y-4">
                        <div>
                            ...
                            <input id="email"
                                className="border p-3 shadow-md placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-[90%]"
                        ...
                        <a className="mr-5 group text-blue-400 transition-all duration-100 ease-in-out" href="#">
                            <span
                        ...
                        <button
                            className="bg-gradient-to-r from-blue-500 to-pink-700 shadow-lg mt-6 p-2 text-white rounded-lg w-[90%] hover:scale-105 hover:from-purple-500 hover:to-blue-500 transition duration-300 ease-in-out"
                            type="submit">
                            SIGN IN
                        </button>
                    </form>
                    <div className="flex flex-col mt-4 items-center justify-center text-sm">
                        <h3>
                            ...
                            <Link className="group text-blue-400 transition-all duration-100 ease-in-out" to="/signup">
                                <span
