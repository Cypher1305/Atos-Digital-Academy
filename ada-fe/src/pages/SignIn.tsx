      ...
      <Header/>
        ...
        <div className="h-auto w-screen flex justify-center items-center">
            <div className="grid gap-5">
                ...
                >
                <h1 className="pt-8 pb-6 font-bold text-3xl text-center cursor-default">
                    Welcome back !
                </h1>
                <form action="#" method="post" className="space-y-4">
                    <div>
                    <label for="email" className="mb-2 text-xl">Email</label>
                    <input
                        id="email"
                    ...
                    <div>
                    <label for="password" className="mb-2 dark:text-gray-400 text-xl">Password</label>
                    <input
                        id="password"
                        className="border p-3 shadow-md placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full"
                        type="password"
                    ...
                    <a
                    className="mr-5 group text-blue-400 transition-all duration-100 ease-in-out"
                    href="#"
                    >
                    <span
                ...
                >
                    <button
                    href="#" className="hover:scale-105 ease-in-out duration-300 shadow-lg p-2 rounded-lg m-1" >
                    <img
